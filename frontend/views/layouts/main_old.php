...
<head>
	...
	<link rel="stylesheet" href="/css/main.css" />
		<link media="screen and (min-width: 0px) and (max-width: 1600px)" rel="stylesheet" type="text/css" href="/css/adaptive1600.css">
		<link media="screen and (min-width: 0px) and (max-width: 1440px)" rel="stylesheet" type="text/css" href="/css/adaptive1440.css">
</head>
<body>
<?php $this->beginBody() ?>
			<div id="preloader">
			...
			<footer>
				<div id="social_block">
					...
					<a href="http://www.amediacymbals.com.tr/" target="_blank" id="amedia" class="clearfix">
						<img src="/images/amedia-logo.png" />
					</a>
					<a href="http://amtelectronics.com/" target="_blank" id="amt" class="clearfix">
